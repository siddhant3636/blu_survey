...
const chargerDataSchema = Joi.object({
  ...
  mccb4pTypes: Joi.array().items(Joi.alternatives().try(Joi.string().trim().allow("", null), Joi.object({ rating: Joi.string().trim().allow("", null), brandId: Joi.string().trim().allow("", null), brandName: Joi.string().trim().allow("", null) }))).allow(null).optional(),
  mcb2p: Joi.string().trim().allow("", null).optional(),
  mcb2pCount: Joi.number().integer().min(0).allow(null).optional(),
  mcb2pTypes: Joi.array().items(Joi.alternatives().try(Joi.string().trim().allow("", null), Joi.object({ rating: Joi.string().trim().allow("", null), brandId: Joi.string().trim().allow("", null), brandName: Joi.string().trim().allow("", null) }))).allow(null).optional(),
  mcb4p: Joi.string().trim().allow("", null).optional(),
  mcb4pCount: Joi.number().integer().min(0).allow(null).optional(),
  mcb4pTypes: Joi.array().items(Joi.alternatives().try(Joi.string().trim().allow("", null), Joi.object({ rating: Joi.string().trim().allow("", null), brandId: Joi.string().trim().allow("", null), brandName: Joi.string().trim().allow("", null) }))).allow(null).optional(),
